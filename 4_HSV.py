...
cv2.createTrackbar("ls", "mask", 45, 255, nothing)
cv2.createTrackbar("lv", "mask", 107, 255, nothing)
cv2.createTrackbar("hh", "mask", 31, 255, nothing)
...
while (True):
    ...
    for i in range(1, num_labels):
        ...
        if (a >= 500):
            ...
            cv2.rectangle(frame, (l, t), (l + w, t + h), (0, 0, 0), cv2.FILLED)
